...
<div id="templatemo_top"> <a href="<?php echo base_url(); ?>welcome/softwer">Home</a> | <a href="http://fs.1netbd.com/" target="_parent">Back to Media server</a></div>
...
<?php 
 ...
 ?>
  <tr style="border-bottom:1px solid #00557F;">
    <td style="width:200px; border-right:1px solid #00557F;" ><a href="<?php echo $search_result->softwer_link ?>"> <?php echo $search_result->softwer_name ?></a></td>
    <td style="width:450px; border-right:1px solid #00557F; font-weight:normal; text-align:justify; " ><?php echo $search_result->softwer_desc ?></td>
    <td style="width:70px;" ><?php echo $search_result->softwer_size ?></td>
  </tr>
    <?php } ?>
</tbody>
</table>
