    ...
    <tr>
        ...
        ?>
         <a class="btn btn-success" href="<?php echo base_url();?>/super_admin/published_admin/<?php echo $show_admin->id;?>">
            ...
            <a class="btn btn-danger" href="<?php echo base_url();?>/super_admin/delete_admin/<?php echo $show_admin->id;?>" title="Delete" onclick="return confirm('Are you sure want to delete ??')">
