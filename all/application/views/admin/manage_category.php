...
<?php  
    foreach ($view_category as $show_category) 
    {
    ?>
    <tr>
       ...
       <td class="center">
            ...
            <a class="btn btn-danger" href="<?php echo base_url();?>/super_admin/delete_category/<?php echo $show_category->category_id;?>" title="Delete" onclick="return confirm('Are you sure want to delete ??')">
