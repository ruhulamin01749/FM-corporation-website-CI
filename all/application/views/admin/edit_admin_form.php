            ...
            <div class="box-content">
                <form name="edit_admin_form" role="form" action="<?php echo base_url(); ?>/super_admin/update_admin" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name="admin_name" class="form-control" id="exampleInputEmail1" placeholder="admins Name........." value="<?php echo $admin_info->name;?>" required>
                        <input type="hidden" name="admin_id" value="<?php echo $admin_info->id;?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Admins email</label>
                        <input type="text" name="admin_email" class="form-control" id="exampleInputEmail1" placeholder="admins email........." value="<?php echo $admin_info->email;?>" required>
                        
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Admins Password</label>
                        <input type="password" name="admin_password" class="form-control" id="exampleInputEmail1" placeholder="New password........." value="">
